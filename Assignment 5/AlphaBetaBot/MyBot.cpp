...
int MinMaxAlgo(OthelloBoard board, int depth, Turn turn, bool maxPlayer, int alpha, int beta, int parentID){
    functionNumber += 1;
    ...
    if(maxPlayer){
        ...
        for(Move currentMove : possibleMoves){
            ...
            int returnVal = MinMaxAlgo(interBoard, depth - 1, other(turn), false, alpha, beta, functionNumber);
        ...
        for(Move currentMove : possibleMoves){
            ...
            int returnVal = MinMaxAlgo(interBoard, depth - 1, other(turn), true, alpha, beta, functionNumber);
...
{   
    ...
    for(int depth = min_depth; depth <= max_depth; depth++){
        for (Move nextMove : possibleMoves){
            ...
            returnVal = MinMaxAlgo(currentBoard, depth, other(turn), true, INT_MIN + 1, INT_MAX - 1, functionNumber);
